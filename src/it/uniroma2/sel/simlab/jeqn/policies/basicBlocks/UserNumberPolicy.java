 ...
 */
public class UserNumberPolicy implements ExplicitInputPolicy<SonUser, Integer> {

    public Integer getDecisionFor(SonUser u) {
        return new Integer(u.getNumberOfSiblings());
    }
}
