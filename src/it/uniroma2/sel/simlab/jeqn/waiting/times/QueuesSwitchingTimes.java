...
/** Defines the interface for the structure containing the switching times between
 * all the queues in a Multi-queue structure.
 *
 * @author  Daniele Gianni
 */
public interface QueuesSwitchingTimes {
